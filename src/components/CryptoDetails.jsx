...
import { cryptoApi, useGetCryptoDetailsQuery, useGetCryptoHistoryQuery } from '../services/cryptoApi';
      ...
      <Col className='stats-container'>
        <Col className='coin-value-statistics'>
          <Col className='coin-value-statistics-heading'>
            <Title level={3} className='cion-details-heading'>
